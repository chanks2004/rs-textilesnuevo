...
const tshirtColors = {
  ...
  burgundy: { color: "Burgundy", colorCode: "#800020" },
  sage: { color: "Sage", colorCode: "#9DC183" },
};
...
const hatColors = {
  black: { color: "Black", colorCode: "#0A0A0A" },
  navy: { color: "Navy", colorCode: "#1E3A5F" },
  khaki: { color: "Khaki", colorCode: "#C3B091" },
  white: { color: "White", colorCode: "#FFFFFF" },
  charcoal: { color: "Charcoal", colorCode: "#36454F" },
};
  ...
  products: [
    // T-SHIRTS - LIGHTWEIGHT (up to 200 GSM)
    {
      ...
      variants: [
        ...
        { ...tshirtColors.white, image: "/images/tshirts/200-boxy-cream.jpg" },
        { ...tshirtColors.grey, image: "/images/tshirts/220-oversized-black.jpg" },
    ...
    },
    {
      ...
      variants: [
        ...
        { ...hoodieColors.sage, image: "/images/hoodies/350-ultra-natural.jpg" },
    ...
    },
    {
      ...
      variants: [
        ...
        { ...hatColors.khaki, image: "/images/hats/structured-charcoal.jpg" },
        { ...hatColors.white, image: "/images/hats/trucker-navywhite.jpg" },
      ],
      fabric: "100% Cotton",
