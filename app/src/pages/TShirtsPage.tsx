...
export function TShirtsPage() {
  ...
  const getProductsByTier = (tier: typeof tshirtTiers[0]) => {
    return productsConfig.products.filter(
      (product) => product.category === 'tshirt' && product.gsm && product.gsm >= tier.gsmRange[0] && product.gsm <= tier.gsmRange[1]
    );
  };
    ...
    <div className="pt-20">
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-[#6A6A6A] mb-6">
            ...
            <span>/</span>
            <span className="text-[#0A0A0A]">T-Shirts</span>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold text-[#0A0A0A] mb-6">Premium T-Shirts</h1>
              <p className="text-lg text-[#6A6A6A] mb-8">
                From lightweight 180GSM basics to ultra-heavyweight 330GSM statement pieces. Find the perfect tee for your brand, with 50+ colors available for every style.
              </p>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 aspect-square flex items-center justify-center">
              <img src="/images/tshirts/260-ultra-espresso.jpg" alt="Premium T-Shirts" className="max-w-full max-h-full object-contain" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-20 pt-16 border-t border-gray-200">
            <div className="text-center mb-12">
              ...
              <p className="text-[#6A6A6A]">Featured T-shirts most popular among brands and businesses</p>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-[#0A0A0A]">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto mb-8">Get a custom quote for your t-shirt order. We offer competitive pricing and fast turnaround times.</p>
